...
(assert (let ((a!1 (forall ((i Int))
             (! (let ((a!1 (ite (= i 4)
                ...
                :skolemid _skolem_28
                :qid _forall_18)))
      (a!2 (<= (__f2 (__f3 (__f2 initial_2_trace))) 1))
      (a!3 (>= (__f2 (__f3 (__f2 initial_2_trace))) 0))
      (a!4 (<= (__f1 (__f2 (__f2 initial_2_trace))) initial_1_start))
      (a!5 (= (__f1 (__f2 (__f2 initial_2_trace))) initial_1_start))
      (a!6 (<= (__f2 (__f2 (__f2 initial_2_trace))) 0))
      (a!7 (<= 0 (__f1 (__f2 (__f2 initial_2_trace))))))
(let ((a!8 (or (= (__f2 (__f2 initial_2_trace)) (_tuple_1 initial_1_start 0))
               (not a!4)
               (and a!5 (not a!6))
               (and (not a!7) (<= 0 initial_1_start)))))
  (not (or (not a!1) (and a!2 a!3 a!8))))))
