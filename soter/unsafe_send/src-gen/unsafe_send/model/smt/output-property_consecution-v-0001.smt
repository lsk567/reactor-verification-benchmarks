(declare-datatypes ((_enum_0 0)) (((unsafe_send_reaction_0) (unsafe_send_reaction_1) (unsafe_send_s_reaction_0) (unsafe_send_s_reaction_1) (NULL))))
  ...
  (! (let ((a!1 (not (and (not (<= i 0)) (<= i 5))))
     ...
     (let ((a!3 (ite (= i 1)
           ...
           (a!6 (ite (= i 2)
                     ...
                     (ite (= i 3)
                          (__f3 initial_2_trace)
                          (ite (= i 4) (__f4 initial_2_trace) a!5)))))
     (let ((a!4 (__f2 (__f3 (ite (= i 0) (__f1 initial_2_trace) a!3))))
           (a!7 (__f2 (__f3 (ite (= i 1) (__f1 initial_2_trace) a!6))))
           (a!8 (= (__f1 (ite (= i 0) (__f1 initial_2_trace) a!3))
                   unsafe_send_reaction_0)))
       (or a!1 (= a!4 a!7) a!8))))
     :skolemid _skolem_0
     :qid _forall_0)))
(assert true)
...
(assert (forall ((i Int))
  (! (let ((a!1 (not (and (not (<= i 0)) (<= i 5))))
     ...
     (let ((a!4 (= (__f1 (ite (= i 0) (__f1 initial_2_trace) a!3))
           ...
           (a!6 (__f1 (__f3 (ite (= i 0) (__f1 initial_2_trace) a!3))))
  ...
  (! (let ((a!1 (not (and (not (<= i 0)) (<= i 5))))
     ...
     (let ((a!3 (ite (= i 1)
                     ...
                     (ite (= i 2)
                          ...
                          (ite (= i 3) (__f4 initial_2_trace) a!2)))))
     (let ((a!4 (__f2 (__f3 (ite (= i 0) (__f1 initial_2_trace) a!3))))
           (a!6 (= (__f1 (ite (= i 0) (__f1 initial_2_trace) a!3))
                   unsafe_send_reaction_0)))
       (or a!1 (and (not (<= 0 a!4)) a!5) (not a!6)))))
     :skolemid _skolem_17
     :qid _forall_10)))
(assert (forall ((i Int))
  (! (let ((a!1 (ite (= i 4)
