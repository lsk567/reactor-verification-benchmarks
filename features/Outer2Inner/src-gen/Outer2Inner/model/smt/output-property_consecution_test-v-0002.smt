...
(declare-datatypes ((_enum_0 0)) (((Outer2Inner_reaction_0) (Outer2Inner_a_reaction_0) (NULL))))
...
(declare-datatypes ((_tuple_3 0)) (((_tuple_3 (__f1 _tuple_0) (__f2 _tuple_0) (__f3 _tuple_0)))))
...
(assert (forall ((j Int))
  (! (let ((a!1 (ite (= j 1)
                     ...
                     (ite (= j 2)
                          ...
                          (_tuple_0 NULL (_tuple_1 (- 1) 0) (_tuple_2 0)))))
           (a!3 (not (and (not (<= j 0)) (<= j 2)))))
     (let ((a!2 (= (__f1 (ite (= j 0) (__f1 initial_2_trace) a!1)) NULL)))
       (or a!2
           a!3
           (forall ((i Int))
  ...
  (! (let ((a!1 (ite (= j 1)
           ...
           (a!4 (ite (= j 2)
                     ...
                     (ite (= j 3)
                          ...
                          (_tuple_0 NULL (_tuple_1 (- 1) 0) (_tuple_2 0))))))
     (let ((a!2 (= (__f1 (ite (= j 0) (__f1 initial_2_trace) a!1)) NULL))
           (a!5 (= (__f3 (ite (= j 0) (__f1 initial_2_trace) a!1))
           ...
           (exists ((j Int))
             (! (let ((a!1 (ite (= j 1)
                ...
                (let ((a!2 (= (__f1 (ite (= j 0) (__f1 initial_2_trace) a!1))
                              Outer2Inner_reaction_0))
                      (a!4 (__f1 (__f2 (ite (= j 0) (__f1 initial_2_trace) a!1))))
                      (a!5 (__f2 (__f2 (ite (= j 0) (__f1 initial_2_trace) a!1)))))
...
(assert (forall ((i Int))
  (! (let ((a!1 (not (and (not (<= i 0)) (<= i 2))))
     ...
     (let ((a!3 (= (__f1 (ite (= i 0) (__f1 initial_2_trace) a!2))
           ...
           (a!6 (__f1 (__f3 (ite (= i 1) (__f1 initial_2_trace) a!5)))))
       (or a!1 (not a!3) (= a!4 a!6))))
     :skolemid _skolem_6
     :qid _forall_5)))
(assert (forall ((i Int))
  (! (let ((a!1 (not (and (not (<= i 0)) (<= i 2))))
     ...
     (let ((a!3 (= (__f1 (ite (= i 0) (__f1 initial_2_trace) a!2))
       ...
       (or a!1 (not a!3) (and a!4 (= a!5 a!7)))))
     :skolemid _skolem_8
     :qid _forall_6)))
(assert (forall ((i Int))
  (! (let ((a!1 (not (and (not (<= i 0)) (<= i 2))))
...
(assert (let ((a!1 (or (not (= initial_1_start 0))
               (exists ((i Int))
                 (! (let ((a!1 (ite (= i 1)
                    ...
                    (let ((a!2 (= (__f1 (ite (= i 0) (__f1 initial_2_trace) a!1))
                                  Outer2Inner_reaction_0))
                          (a!3 (= (__f2 (ite (= i 0) (__f1 initial_2_trace) a!1))
                                  (_tuple_1 0 0))))
                      (and (>= i 0) (<= i 2) a!2 a!3)))
                    :skolemid _skolem_12
                    :qid _exists_2))))
...
(assert (forall ((i Int) (j Int))
  (! (let ((a!1 (ite (= i 1)
     ...
     :qid _forall_10)))
(assert (forall ((i Int))
  (! (not (and (>= i 0) (<= i 1))) :skolemid _skolem_15 :qid _forall_11)))
