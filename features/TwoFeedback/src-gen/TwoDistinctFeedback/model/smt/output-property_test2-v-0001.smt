...
(assert (forall ((i Int))
  (! (let ((a!1 (_tuple_0 NULL
     ...
     (let ((a!4 (ite (= i 0)
                     (__f1 initial_2_trace)
                     (ite (= i 1) (__f2 initial_2_trace) a!3))))
     (let ((a!8 (and (or a!5 (<= 7 i) (and (not a!6) (not a!7)))
                     (not (__f1 (__f4 a!4))))))
       (or (not (and (>= i 0) (<= i 7)))
...
(assert (forall ((i Int) (j Int))
  (! (let ((a!1 (_tuple_0 NULL
     ...
     (let ((a!13 (or (and (= (__f2 a!4) (__f2 a!7))
                          (= (__f1 a!4) TwoDistinctFeedback_reaction_0)
                          (= (__f1 a!7) TwoDistinctFeedback_reaction_1))
                     a!9
                     a!11
                     a!12)))
       (or (not (and (>= i 0) (<= i 7) (>= j 0) (<= j 7)))
  ...
  (! (let ((a!1 (not (and (not (<= i 0)) (<= i 7))))
     ...
     (let ((a!4 (ite (= i 0)
       ...
       (or a!1
           ...
           (= (__f1 (__f4 a!4)) (= (__f1 a!4) TwoDistinctFeedback_reaction_1))))))
     :skolemid _skolem_17
     :qid _forall_10)))
(assert (forall ((i Int))
  (! (let ((a!1 (not (and (not (<= i 0)) (<= i 7))))
...
(assert (forall ((i Int))
  (! (let ((a!1 (not (and (not (<= i 0)) (<= i 7))))
     ...
     (let ((a!4 (ite (= i 0)
       ...
       (or a!1
           (= (__f2 a!4) (_tuple_1 0 0))
           (= (__f2 (__f4 a!4)) (= (__f1 a!4) TwoDistinctFeedback_reaction_0))))))
     :skolemid _skolem_19
     :qid _forall_12)))
(assert (forall ((i Int))
  (! (let ((a!1 (_tuple_0 NULL
     ...
     (let ((a!4 (ite (= i 0)
                     (__f1 initial_2_trace)
                     (ite (= i 1) (__f2 initial_2_trace) a!3))))
     (let ((a!8 (and (or (<= 7 i) a!5 (and (not a!6) (not a!7)))
                     (not (__f2 (__f4 a!4))))))
       (or (not (and (>= i 0) (<= i 7)))
  ...
  (! (let ((a!1 (ite (= i 6)
     ...
     (let ((a!3 (ite (= i 0)
                     ...
                     (ite (= i 1)
                          (__f2 initial_2_trace)
                          (ite (= i 2) (__f3 initial_2_trace) a!2)))))
       (and (= (__f1 a!3) TwoDistinctFeedback_reaction_1)
            (= (__f2 a!3) (_tuple_1 4000000000 0))))))
     :skolemid _skolem_24
     :qid _exists_10)))
